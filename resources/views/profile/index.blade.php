        ...
        <x-card>
            ...
            <form action="/profile/" method="post" class="pt-4">
                ...
                <div class="mb-4">
                    ...
                    <input placeholder="••••••••" type="password" name="current_password" id="current_password" class="border-2 bg-transparent rounded w-1/2 py-2 px-3 text-[#FFEB99] placeholder-[#FFEB99]::placeholder focus:outline-none focus:border-[#FFEB99]">
                ...
                <div class="mb-4">
                    ...
                    <input placeholder="••••••••" type="password" name="new_password" id="new_password" class="border-2 bg-transparent rounded w-1/2 py-2 px-3 text-[#FFEB99] placeholder-[#FFEB99]::placeholder focus:outline-none focus:border-[#FFEB99]">
                    @error('new_password')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-4">
                    ...
                    <input placeholder="••••••••" type="password" name="new_password_confirmation" id="new_password_confirmation" class="border-2 bg-transparent rounded w-1/2 py-2 px-3 text-[#FFEB99] placeholder-[#FFEB99]::placeholder focus:outline-none focus:border-[#FFEB99]">
