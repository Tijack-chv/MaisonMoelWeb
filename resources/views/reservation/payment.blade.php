<x-header title="bg-[#353535]">
    <x-navbar></x-navbar>
    <div id="toast-success" class="absolute right-5 bottom-3 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow " role="alert" style="display:none;">
    ...
    <div class="mt-6 mb-6">
        <x-card-payment>
            <ol class="flex items-center w-full text-sm font-medium text-center text-gray-500  sm:text-base mb-2 mt-4 sm:flex hidden">
                <li class="flex md:w-full items-center text-[#FFEB99] sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10">
                    <span class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-[#FFEB99] ">
                ...
                <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                    <div class="mx-auto max-w-5xl">
                        ...
                        <div class="mt-6 sm:mt-4 lg:flex lg:items-start lg:gap-12">
                            <form id="paymentForm" action="#" class="w-full rounded-lg border border-gray-200 bg-white p-4 shadow-sm  sm:p-6 lg:max-w-xl lg:p-8">
                                @csrf
                                <div class="mb-6 grid grid-cols-2 gap-4">
                                    <div class="col-span-2 sm:col-span-1">
                                        <label for="full_name" class="mb-2 block text-sm font-medium text-gray-900">Nom complet <span class="text-red-600">*</span></label>
                                    ...
                                    <div class="col-span-2 sm:col-span-1">
                                        <label for="card-number-input" class="mb-2 block text-sm font-medium text-gray-900">Numéro de carte <span class="text-red-600">*</span></label>
                                    ...
                                    <div>
                                        <label for="card-expiration-input" class="mb-2 block text-sm font-medium text-gray-900 ">Expiration de la carte <span class="text-red-600">*</span></label>
                                        <div class="relative">
                            ...
                            <div class="mt-6 grow sm:mt-8 lg:mt-0">
                                <div class="space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6">
                                    ...
                                    <dl class="flex items-center justify-between gap-4">
                                        <dt class="text-base font-normal text-gray-500">Prix original</dt>
                                        <dd class="text-base font-medium text-gray-900">{{ session()->get('reservation')['nb_personnes'] * 10 }}.00 €</dd>
                                    </dl>

                                    <dl class="flex items-center justify-between gap-4">
                                        <dt class="text-base font-normal text-gray-500">Réduction</dt>
