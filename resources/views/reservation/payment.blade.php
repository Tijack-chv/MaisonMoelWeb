<x-header title="bg-[#353535]">
    ...
    <div class="mt-6 mb-6">
        <x-card-payment>
            <section class="py-2 antialiased md:py-2">
                <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                    <div class="mx-auto max-w-5xl">
                    <h2 class="text-xl font-semibold text-white sm:text-2xl">Paiement</h2>
                    ...
                    <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12">
                        ...
                        <div class="mb-6 grid grid-cols-2 gap-4">
                            ...
                            <button type="submit" class="flex w-full items-center justify-center rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-primary-300">Payer</button>
                        </form>
